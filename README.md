...
- **Tools**: Git, GitHub, Chrome Dev Tools
...
| FAQ Accordion         | HTML, CSS                                   | [link](https://matt-miguel.github.io/faq-accordian/)                |

## Running Locally

```bash
git clone https://github.com/matt-miguel/my-dev-portfolio.git
npm install
npm run dev
```
